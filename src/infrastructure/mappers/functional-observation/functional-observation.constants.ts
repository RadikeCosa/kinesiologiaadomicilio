...
export const FUNCTIONAL_OBSERVATION_CODE_SYSTEM = "https://kinesiologiaadomicilio.local/fhir/CodeSystem/functional-observations";
...
export const FUNCTIONAL_OBSERVATION_DEFINITIONS: Record<FunctionalObservationCode, { fhirCode: string; display: string; unit: string; quantitySystem?: string; quantityCode?: string }> = {
  ...
  gait_duration_minutes: { fhirCode: "gait-duration-minutes", display: "Marcha (minutos)", unit: "min", quantitySystem: "http://unitsofmeasure.org", quantityCode: "min" },
};
