...
export const episodeDiagnosisSchema = z.object({
  kind: z.enum(["medical_reference", "kinesiologic_diagnosis"]),
...
export const upsertEpisodeClinicalContextSchema = z.object({
  ...
  kinesiologicDiagnosis: episodeDiagnosisSchema.extend({ kind: z.literal("kinesiologic_diagnosis") }).optional(),
